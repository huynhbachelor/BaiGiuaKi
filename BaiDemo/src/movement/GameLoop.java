...
public class GameLoop implements Runnable{
    ...
    private Demo demo;
    public static ArrayList<Quai> characters;
    ...
    public GameLoop(boolean isRunning, Demo demo) {
        ...
        nv= new Nhanvat(new Vector2D(500, 350), 0, new Vector2D(0, 0), 0, Color.RED);
...
//            this.characters.get(1).setPosition(new Vector2D(500, 500));
            ...
            if(countQuai<37){
                ...
                Quai q = new Quai(new Vector2D(
                    x + 30 +(int) ( 60*Math.sin(Math.toRadians(10*countQuai)))
                    , y + 30 + (int) ( 60*Math.cos(Math.toRadians(10*countQuai)))), 
